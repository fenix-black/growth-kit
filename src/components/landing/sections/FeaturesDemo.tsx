          ...
          {[
            ...
            >
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-green-600">{t('features.fingerprinting.active')}</div>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="bg-gradient-to-r from-fenix-purple/10 to-fenix-magenta/10 rounded-xl p-4 border border-fenix-purple/20 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium text-gray-900">{t('features.referrals.sarahReferrals')}</span>
            </div>
            <div className="text-fenix-purple font-bold">+15 {t('features.referrals.credits')}</div>
          </div>
